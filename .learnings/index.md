# T-Minus Learnings Index

Accumulated insights from epic retrospectives. Organized by category.
...
- [Testing](testing.md) - Integration test patterns, test setup, coverage strategies, E2E testing
- [Architecture](architecture.md) - DO patterns, API design, crypto choices, envelope encryption, KV design
- [Tooling](tooling.md) - Cloudflare Workers runtime quirks, wrangler configs, deployment automation
- [Process](process.md) - Delivery evidence, AC verification, migration numbering, git workflow
