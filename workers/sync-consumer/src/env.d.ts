...
interface Env {
  ...
  SYNC_QUEUE: Queue;
  ENVIRONMENT?: string;
  DELETE_GUARD_ENABLED?: string;
  DELETE_GUARD_MAX_DELETES_PER_SYNC_RUN?: string;
  DELETE_GUARD_MAX_DELETES_PER_ACCOUNT_BATCH?: string;
  DELETE_GUARD_MAX_DELETES_PER_BATCH?: string;
}
